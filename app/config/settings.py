...
env.read_env(path=os.path.join(PROCESS_DIR, ".env"))
...
if DEBUG:
    MIDDLEWARE += ["app.core.middleware.DebugMiddleware"]
    ...
    LOGGING = {
        ...
        "handlers": {
            "file": {
                ...
                "filename": os.path.join(PROCESS_DIR, "logs", "app.log"),
                "formatter": "verbose",
            },
        },
        "formatters": {
